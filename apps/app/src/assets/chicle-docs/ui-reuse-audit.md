...
- The Docs and Flow workspace intrinsic-width defects found during the mobile pass were corrected.
...
| `/docs` | `PageShellComponent` | Process guide, notices and component registry | Long-form Docs navigation |
| `/docs/source` | `PageShellComponent` | Shared documentation layout and Markdown viewer | Markdown repository browser |
...
| Themes | `UiThemeSelectorComponent` | Component library and screen/form designers |
...
- Docs section navigation, Architecture articles and Markdown repository layout.
