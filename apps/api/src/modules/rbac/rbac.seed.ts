...
export const BASE_PERMISSIONS: BasePermissionSeed[] = [
  ...
  { key: 'env.read', category: 'environment', description: 'Ver ambientes, variables públicas y readiness de despliegue.' },
  { key: 'env.update', category: 'environment', description: 'Administrar perfiles de ambiente y variables no secretas.' },
  { key: 'secrets.write', category: 'secrets', description: 'Crear o reemplazar secrets cifrados de ambientes.' },
  { key: 'secrets.rotate', category: 'secrets', description: 'Rotar secrets cifrados con trazabilidad.' },
  { key: 'deploy.validate', category: 'deploy', description: 'Validar readiness de despliegue por ambiente.' },
  { key: 'deploy.generate', category: 'deploy', description: 'Generar artefactos revisables de despliegue.' },
  { key: 'service_registry.manage', category: 'deploy', description: 'Administrar URLs y contratos de servicios por ambiente.' },
